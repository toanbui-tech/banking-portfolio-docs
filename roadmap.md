---
title: Banking Engineering Roadmap
description: Lộ trình 3-6 tháng xây dựng Core Banking System và Interbank Payment Gateway bằng Java/Spring
---

# Banking Engineering Roadmap

> Lộ trình học tập & xây dựng portfolio hướng tới vị trí Junior-to-Middle Java FullStack tại các ngân hàng FDI / fintech. Mục tiêu kép: (1) hiểu sâu nghiệp vụ banking + Java + hệ sinh thái Spring, (2) có 2 dự án thực chiến để đưa vào CV.
...
## Giai đoạn 1 — Tháng 1–2: Core Banking (Sub-project B)
...
## Giai đoạn 2 — Tháng 3–4: Interbank Payment Gateway (Sub-project A)
...
## Giai đoạn 3 — Tháng 5–6: Tích hợp, đào sâu & hoàn thiện CV
...
- **Học trước, code sau**: mỗi module chính đều bắt đầu bằng việc đọc tài liệu gốc (Spring docs, ISO20022 spec), không phải đọc để "biết" mà đọc để hiểu vì sao thiết kế như vậy.
...
> Phần này sẽ được cập nhật theo thời gian khi triển khai từng giai đoạn.
