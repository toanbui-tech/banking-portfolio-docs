...
| Truy vết lịch sử thay đổi & hoàn tác giao dịch | <span class="status-badge wip">Một phần</span> | Tầng lõi đã ghi nhận người tạo mỗi giao dịch và hỗ trợ hoàn tác đối xứng; chưa mở chức năng này ra API cho người dùng |
